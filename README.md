...
- **`EXPLANATION.md`** — 1–2 sentence explanations after every command/execution.
...
Each folder is self-contained. Read the folder's `EXPLANATION.md` first, then run the commands or compile the source as noted.

> **Screenshots reminder:** The `screenshots/` folder in each question is a placeholder. Run each command on your own machine and drop the captured PNGs there before submitting — the assignment requires a screenshot of each command's execution and output.

> **Reminder:** Make the GitHub repository **public** before submitting. Private repos are graded 0.
